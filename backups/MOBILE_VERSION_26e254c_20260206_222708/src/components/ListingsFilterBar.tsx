      ...
      {USE_PILL_DESIGN && (
        <div className="backdrop-blur-xl bg-white/90 border border-white/60 rounded-full p-0.5 md:p-2 shadow-2xl flex items-center gap-0.5 md:gap-2 overflow-visible">
          ...
          <div className="relative flex-1 min-w-0">
            ...
            {openSection === "mood" && (
              <div className="absolute top-full left-1/2 -translate-x-1/2 -ml-6 md:ml-0 mt-2 p-3 bg-white rounded-xl shadow-xl z-50 min-w-[280px] max-w-[calc(100vw-32px)] animate-fade-in">
                {selectedMood.slug && (
          ...
          <div className="relative flex-1 min-w-0">
            ...
            {openSection === "location" && (
              <div className="absolute top-full left-1/2 -translate-x-1/2 -ml-6 md:ml-0 mt-2 p-3 bg-white rounded-xl shadow-xl z-50 min-w-[220px] max-w-[calc(100vw-32px)] md:w-[220px] animate-fade-in">
