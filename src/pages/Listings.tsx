  ...
  const FilterContent = () => (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <h3 className="text-xs font-bold text-purple-900 uppercase tracking-wide">Wann?</h3>
        <button 
          onClick={() => setShowCalendar(true)}
          className="w-full px-4 py-3.5 bg-white hover:bg-purple-50 rounded-xl text-purple-900 transition-all flex items-center justify-center gap-2.5 font-semibold border border-purple-200"
        >
      ...
      <div className="space-y-3">
        <h3 className="text-xs font-bold text-purple-900 uppercase tracking-wide">Stimmung</h3>
      ...
      {/* Preis (Price) */}
      <div className="space-y-3">
        <h3 className="text-xs font-bold text-purple-900 uppercase tracking-wide">Budget</h3>
        <div className="grid grid-cols-4 gap-1 p-1 bg-white rounded-xl border border-purple-200">
      ...
      {/* Stadt und Radius */}
      <div className="space-y-3">
        <h3 className="text-xs font-bold text-purple-900 uppercase tracking-wide">Wo?</h3>
        <div className="relative">
          ...
          <input
            ...
            list="cities"
            className="w-full pl-12 pr-4 py-3.5 bg-white rounded-xl text-sm text-purple-900 font-medium placeholder:text-purple-400 focus:outline-none focus:ring-2 focus:ring-purple-300 transition-all border border-purple-200"
          />
          <datalist id="cities">
            {cities.map((city) => (
        ...
        <div className="pt-2 px-1">
          ...
          <div className="flex justify-between items-center mt-3">
            <span className="text-xs text-purple-900 font-medium">Umkreis</span>
            <span className="text-sm font-bold text-purple-900 tabular-nums bg-white px-3 py-1 rounded-lg border border-purple-200">{radius[0]} km</span>
          </div>
        </div>
      </div>
      ...
      {/* Kategorie */}
      <div className="space-y-3">
        <h3 className="text-xs font-bold text-purple-900 uppercase tracking-wide">Kategorie</h3>
        <Select value={selectedCategory} onValueChange={setSelectedCategory}>
          <SelectTrigger className="w-full rounded-xl border border-purple-200 bg-white py-3.5 text-sm font-medium text-purple-900 focus:ring-2 focus:ring-purple-300 hover:bg-purple-50 transition-all">
            <SelectValue placeholder="Alle Kategorien" />
          </SelectTrigger>
          <SelectContent className="bg-white border border-purple-200 shadow-xl rounded-xl overflow-hidden z-50">
            {categories.map((cat) => (
              <SelectItem 
                key={cat.value} 
                value={cat.value} 
                className="cursor-pointer py-3 text-sm font-medium focus:bg-purple-50 text-purple-900"
              >
                {cat.label}
              </SelectItem>
            ))}
      ...
      {/* Subkategorie */}
      <div className="space-y-3">
        <h3 className="text-xs font-bold text-purple-900 uppercase tracking-wide">Art</h3>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex gap-10">
          ...
          <aside className="hidden lg:block w-72 flex-shrink-0">
            <div className="sticky top-24 bg-purple-50 rounded-2xl p-6 shadow-lg shadow-purple-200/50 border border-purple-200 max-h-[calc(100vh-120px)] overflow-y-auto">
              <FilterContent />
            </div>
          </aside>
