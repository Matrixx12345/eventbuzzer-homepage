...
interface ChatbotPopupRightProps {
  isOpen: boolean;
  onClose: () => void;
  onOpen: () => void;
...
const ChatbotPopupRight = ({ isOpen, onClose, onOpen, onFilterApply }: ChatbotPopupRightProps) => {
  ...
  return (
    <>
      {/* Main Panel - RECHTS positioniert (KEIN Chevron Handle) */}
      <div
...
export default ChatbotPopupRight;
