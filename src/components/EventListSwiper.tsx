        ...
        {noMoreEvents ? (
          ...
          <div className="relative w-full h-full md:w-auto md:h-auto md:mb-12" style={{ overscrollBehavior: 'none' }}>
            ...
            >
              ...
              {/* Card Content - Mobile: flex-col (55vh image, 45vh text) | Tablet/Desktop: block */}
              <div className="h-full flex flex-col md:block">
                {/* Photo - Mobile: 55vh fixed (viewport-based, not percentage) | Tablet/Desktop: framed */}
                <div className="h-[55vh] flex-none md:h-auto md:p-3 md:pb-0">
                  ...
                  {/* Floating Icon Bar - Mobile only (Right edge, higher in photo, more spacing) */}
                  <div className="md:hidden absolute right-4 top-[42vh] -translate-y-1/2 flex flex-col gap-6 z-20">
                    {/* Filter/Menu Icon */}
                    <button
                      onClick={(e) => {
                        e.preventDefault();
                ...
                <div className="h-[45vh] flex-none flex flex-col relative md:h-auto md:block md:overflow-y-auto">
            ...
            {currentIndex > 0 && displayEvents[currentIndex - 1] && (() => {
              ...
              return (
                ...
                >
                  ...
                  {/* Card Content - matches main card exactly */}
                  <div className="h-full flex flex-col md:block">
                    {/* Photo - 55vh */}
                    ...
                    {/* Text + SVG - 45vh (exactly matches main card) */}
                    <div className="h-[45vh] flex-none flex flex-col relative md:h-auto md:block md:overflow-y-auto">
              ...
              return (
                ...
                >
                  ...
                  <div className="h-full flex flex-col">
                    {/* Photo - 55vh (viewport-based, matches main card) */}
                    <div className="h-[55vh] flex-none">
                      <div className="relative h-full">
                        <img
